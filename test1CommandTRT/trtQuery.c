...
//============================================
uint8_t trtTaskState(uint8_t tsk) 
{
	struct task *t;
...
//============================================
uint16_t trtTaskStack(uint8_t tsk) 
{
	struct task *t;
	t = &kernel.tasks[tsk]; // struct field syntax t->state 
...
//============================================
uint16_t trtTaskStackBottom(uint8_t tsk) 
{
	struct task *t;
	t = &kernel.tasks[tsk]; // struct field syntax t->state 
...
//============================================
uint32_t trtTaskRelease(uint8_t tsk) 
{
	struct task *t;
	t = &kernel.tasks[tsk]; // struct field syntax t->state 
	return t->release ;
...
//============================================
uint32_t trtTaskDeadline(uint8_t tsk) 
{
	struct task *t;
	t = &kernel.tasks[tsk]; // struct field syntax t->state 
	return t->deadline ;
...
//============================================
uint16_t trtTaskStackFreeMin(uint8_t tsk)
{
	struct task *t;
	uint16_t stk;
	uint8_t *i;
	...
	for (i=(uint8_t*)t->stack_bottom; i<(uint8_t*)stk; i++)
	{
		if (*i != 0xaa) break;
	}
	return i - (uint8_t*)t->stack_bottom;
